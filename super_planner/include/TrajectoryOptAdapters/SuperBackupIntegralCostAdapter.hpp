...
{
class SuperBackupIntegralCostAdapter
{
public:
    const super_utils::PolyhedronH *h_poly = nullptr;
    ...
    void reset(const super_utils::PolyhedronH *poly,
               double smoothing,
                      ...
                      double & /*gt*/) const
    {
        ...
        local_cost += traj_opt_components::accumulatePolytopePositionPenalty(*h_poly,
                                                                             p,
                                                                             smooth_eps,
                                                                             weight_pos,
                                                                             grad_pos,
