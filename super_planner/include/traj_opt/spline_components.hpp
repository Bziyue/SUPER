...
#include <TrajectoryOptComponents/SuperBackupIntegralCost.hpp>
#include <TrajectoryOptComponents/SuperExpIntegralCost.hpp>
...
using ExpPenaltyIntegralCost = traj_opt_components::ExpPenaltyIntegralCost;
using BackupPenaltyIntegralCost = traj_opt_components::BackupPenaltyIntegralCost;
